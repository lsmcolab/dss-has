...
//            ImageIO.write ( image, "png", new File( "C:/Users/LukePc/Desktop/japa/BOIDSs/" + counter + rand.nextInt(10) + 1 + rand.nextInt(100)+".jpeg" ) );
            simplify(points);
            points.clear();
            counter++;
        }
        ...
        public ArrayList<int[]> simplify(ArrayList<int[]> points) throws IOException {
          ...
          //  System.out.println(" new Points" + newpoints);
            ...
            graphics2Di.dispose ();
            //ImageIO.write ( image2, "png", new File( "C:/Users/LukePc/Desktop/japa/BOIDSs/" + "TRANSLATED" + rand.nextInt(10) + 1 + rand.nextInt(100)+".jpeg" ));
            return newpoints;
        }
