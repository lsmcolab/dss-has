...
public class AI_internal_model {
	...
	/*
	 * Method: generate_peference_ais()
	 * remember arguments for and AI_type are: sns, ans ,cns , sw , aw , cw, name
	...
	/*
	 * Method: get_ai_description_line_for_team()
	 * Input: int t
	 * Function:
	 * Return: String
	 */
