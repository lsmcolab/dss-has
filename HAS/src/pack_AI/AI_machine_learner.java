...
/**
 * AI_machine_learner class
 * This class is to Adds points and fits curves with every imaginary boid and it's original's original model
 */
public class  AI_machine_learner {
	...
	// Fourth degree polynomial lists of observed points for a parameter for a team
	...
	/*
	 * Method: calaculate_error()
	 * Input: boid and points
	 * Fucntion:
	...
	/*
	 * Method: initialise_observed_point_lists()
	 * Input: none
	 * Function:
	 * Return: void
	 */
	...
	/*
	 * Method: draw_error_bars()
	 * Input:boid and observer_t
	 * Function:
	 * Return: void
	 */
	...
	/*
	 * Method: record_error_for_observation_of()
	 * Input: observed_t
	 * Function:
	 * Return: void
	 */
	...
	/*
	 * Method: recrod_polynomials_for_observation_of()
	 * Input:int observed_t
	 * Function:
	 * Return: void
	 */
	...
	/*
	 * Method: cull_point_lists()
	 * Input: t
	 * Function:empties recorded data points to stop infinite accumulation
	 * Return: void
	 */
	...
	/*
	 * Method: sum_terms()
	 * Input: param, observed_t
	 * Function:
	 * Return: double terms_total
	 */
	 ...
	 * Method: run()
	 * Input: mind_flock
	 * Function:takes the final state of the imaginary flock
	 * Return: void
	 */
