...
public class DisplayManager {
	...
	/*
	 * Method: draw_teams()
	 * Function: for each member of the team, doing something on the parent object (processing drawing object)
	 * Return: void (action-based)
	 */
	void draw_teams() {
	...
	/*
	 * Method: attempt_draw_ai_indicator()
	 */
