...
public class Boid_generic {
	 ...
	 * Function: if real_step is true all normal actions will happen, otherwise
	 ...
	 * Method: move()
	 * Input: boids
	 * Function:We accumulate a new acceleration each time based on three rules
	 * Return: void (action:
	 */
	 ...
	 * Method: seek()
	 * Input: target
	 * Function:A method that calculates and applies a steering force towards a target
